...
__webpack_unused_export__ = ({value:!0});let e=/*#__PURE__*/t(__webpack_require__(4804)),i=/*#__PURE__*/t(__webpack_require__(4144)),o=__webpack_require__(8796);function t(e){return e&&e.__esModule?e:{default:e}}e.default.init({openTrigger:"data-custom-open",closeTrigger:"data-custom-close",openClass:"is-open",disableScroll:!0,disableFocus:!1,awaitOpenAnimation:!1,awaitCloseAnimation:!1,debugMode:!1}),window.LazyLoadInstance=new i.default;let r=new Set;function n(e){r.add(e)}(0,o.onCLS)(n),(0,o.onINP)(n),(0,o.onLCP)(n),(0,o.onTTFB)(n),(0,o.onFCP)(n),addEventListener("visibilitychange",()=>{"hidden"===document.visibilityState&&function(){if(r.size>0){let e={};r.forEach(i=>{e[i.name]=i}),sessionStorage.setItem("tm-web-vitals",JSON.stringify({metrics:e,origin:{prop2:window.tmAnalytics.properties.prop2,prop3:window.tmAnalytics.properties.prop3,prop4:window.tmAnalytics.properties.prop4,prop5:window.tmAnalytics.properties.prop5,prop9:window.tmAnalytics.properties.prop9,prop10:window.tmAnalytics.properties.prop10,prop14:window.tmAnalytics.properties.prop14}}))}r.clear()}()});
})();
