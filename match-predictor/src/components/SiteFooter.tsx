...
const dataLinks = [{ href: "/sources", label: "Data sources" }];
    ...
    <footer className="relative z-10 border-t border-white/30 bg-white/40 backdrop-blur-xl dark:border-slate-800/50 dark:bg-slate-950/40">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-6 sm:col-span-2 lg:col-span-1 lg:space-y-8">
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-widest text-slate-500 dark:text-slate-400">
                Legal
              </p>
        ...
        <p className="mt-8 border-t border-slate-200/60 pt-6 text-center text-xs text-slate-500 dark:border-slate-800/60 dark:text-slate-500">
          © {year} {BRAND_NAME}. Predictions are estimates, not betting advice.
        </p>
      </div>
    </footer>
  );
