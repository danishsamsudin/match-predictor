...
export function MarketingHero() {
  return (
    <section className="marketing-hero relative min-w-0 max-w-full overflow-hidden rounded-[2rem] px-5 py-12 sm:px-10 sm:py-20">
      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        ...
        <p className="mt-6 text-xl font-bold tracking-tight text-foreground sm:text-3xl">
          {LANDING_HEADLINE}
        </p>
