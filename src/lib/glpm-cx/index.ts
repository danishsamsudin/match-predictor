export { CX_MODEL_VERSION, applyCxToXg } from "@/lib/glpm-cx/apply-cx";
export { buildCxContextFeatures } from "@/lib/glpm-cx/context-features";
...
export { GLPM_CX_GLOSSARY, glossaryTipBody } from "@/lib/glpm-cx/glossary";
