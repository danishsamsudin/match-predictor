"""
Defence Domain Ratings (Chapter 4 Part V).

Prevention = f(Chance Suppression, Defensive Organisation, Transition Defence)
Protection = f(Box Protection, Set Piece Defence)
Control    = f(Pressing, Defensive Territorial Control)
"""
...
DOMAIN_COMPONENT_MAP: dict[str, tuple[str, ...]] = {
    ...
    "protection": ("box_protection", "set_piece_defence"),
    "control": ("pressing", "defensive_territorial_control"),
}

DOMAIN_TARGET_MAP: dict[str, str] = {
    "prevention": "xga_suppression_adj",
    "protection": "blocks_per_box_entry_adj",
    "control": "ppda_inv_adj",
}
