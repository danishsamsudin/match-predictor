"""
Attack Domain Ratings (Chapter 3.16).

Creation  = f(Chance Volume, Chance Quality)
Progression = f(Ball Progression, Territorial Control)
Situational = f(Transition Threat, Set Piece Threat)
"""
...
DOMAIN_COMPONENT_MAP: dict[str, tuple[str, str]] = {
    "creation": ("chance_volume", "chance_quality"),
    "progression": ("ball_progression", "territorial_control"),
    "situational": ("transition_threat", "set_piece_threat"),
}

DOMAIN_TARGET_MAP: dict[str, str] = {
    "creation": "npxg_p90",
    "progression": "field_tilt_adj",
    "situational": "set_piece_xg_per_match_adj",
}
