"""
Pressing Domain Ratings (Chapter 8).

Press Intensity     = f(High Press, Mid-Block Press)
Ball Recovery       = f(Counter-Press, Recovery Efficiency)
Press Effectiveness = f(Press Success, Press Resistance Disruption)
"""
...
DOMAIN_COMPONENT_MAP: dict[str, tuple[str, str]] = {
    "press_intensity": ("high_press", "mid_block_press"),
    "ball_recovery": ("counter_press", "recovery_efficiency"),
    "press_effectiveness": ("press_success", "press_resistance_disruption"),
}

DOMAIN_TARGET_MAP: dict[str, str] = {
    "press_intensity": "high_press_intensity_adj",
    "ball_recovery": "recoveries_per_opp_poss_adj",
    "press_effectiveness": "press_success_index_adj",
}
