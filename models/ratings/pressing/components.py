"""
Pressing Component Rating estimators (Chapter 8).
"""
...
from features.midfield import PRESSING_COMPONENT_FEATURE_GROUPS
from models.ratings.attack.components import LIGHTGBM_MIN_ROWS, future_rolling_mean

COMPONENT_TARGET_MAP: dict[str, str] = {
    "high_press": "high_press_intensity_adj",
    "mid_block_press": "mid_block_intensity_adj",
    "counter_press": "counter_press_efficiency_adj",
    "recovery_efficiency": "recoveries_per_opp_poss_adj",
    "press_success": "press_success_index_adj",
    "press_resistance_disruption": "build_up_disruption_index_adj",
}

COMPONENT_NAMES = tuple(PRESSING_COMPONENT_FEATURE_GROUPS.keys())
...
class ComponentRatingSuite:
    ...
    def __post_init__(self) -> None:
        if not self.models:
            for name, feats in PRESSING_COMPONENT_FEATURE_GROUPS.items():
