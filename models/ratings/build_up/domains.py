"""
Build-Up Domain Ratings (Chapter 6).

Progression  = f(Ball Progression, Vertical Line-Breaking)
Retention    = f(Press Resistance, Security)
Distribution = f(Distribution Accuracy, Tempo)
"""
...
DOMAIN_TARGET_MAP: dict[str, str] = {
    "progression": "final_third_entry_rate_adj",
    "retention": "security_index_adj",
    "distribution": "pass_completion_pct_adj",
}
