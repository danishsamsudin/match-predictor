"""
Build-Up Component Rating estimators (Chapter 6).
"""
...
from features.midfield import BUILD_UP_COMPONENT_FEATURE_GROUPS
...
COMPONENT_TARGET_MAP: dict[str, str] = {
    ...
    "vertical_line_breaking": "through_ball_rate_adj",
    "press_resistance": "press_resist_index_adj",
    "security": "security_index_adj",
    "distribution_accuracy": "pass_completion_pct_adj",
    "tempo": "pass_tempo_adj",
}

COMPONENT_NAMES = tuple(BUILD_UP_COMPONENT_FEATURE_GROUPS.keys())
...
class ComponentRatingSuite:
    ...
    def __post_init__(self) -> None:
        if not self.models:
            for name, feats in BUILD_UP_COMPONENT_FEATURE_GROUPS.items():
